...
Some functionality relies on the following suggested packages: `DiagrammeR` (plots), `glmnet` (adaptive LASSO), `nortest` and `tseries` (residual tests), and `ggplot2` (QQ plots).
