...
**Direct LiNGAM** (`R/lingam_direct.r`): - `measure`:
...
“fpe” - `adjacency_matrices[1,,]` が瞬時構造B0、以降がラグ行列
...
| 関数 | ファイル |
|----|----|
| [`tidy()`](https://generics.r-lib.org/reference/tidy.html), [`glance()`](https://generics.r-lib.org/reference/glance.html) | `R/tidiers.r` |
| [`autoplot.LingamResult()`](https://morimotoosamu.github.io/lingamr/reference/autoplot.LingamResult.md) | `R/autoplot.r` |
| `print.*()` | 各クラスのソースファイル |
